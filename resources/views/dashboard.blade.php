    ...
    <script>
        $(document).ready(function () {
            var dataTable = $('#example').DataTable({
                ...
                "columns": [
                    {
                        //to display numbering/iteration
                        "data": null,
                    ...
                    },
                    {
                        "data": null,
                        "render": function (data, type, row, meta) {
                            // 'meta.row' contains the index of the current row
                            return '<div class="flex space-x-4"> <a href="/edit/' + data.id + '" class="action-link">Edit</a>' +
                           '<a href="#" class="action-link delete-entry" data-entry-id="' + data.id + '">Delete</a> </div>';
                        }
                    },
                ]
            });
